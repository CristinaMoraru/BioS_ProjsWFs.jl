...
"""
function do_wfstep(step::String, proj::BioinfSProj, fun::Function, splatargs, saved, ; logfun::Union{Missing, Function} = missing, splatkwargs = NamedTuple()) # fun::Function
